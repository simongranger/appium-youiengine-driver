...
class YouiEngineDriver extends BaseDriver {
  ...
  constructor (opts, shouldValidateCaps) {
    ...
    this.settings = new DeviceSettings({'TimeDilation': 1, 'SourceTreeFilter': '','HandleRequestsWhenIdle': 'true'},
  ...
  async onSettingsUpdate (key, value) {
    ...
    } else if (key === "HandleRequestsWhenIdle") {
      await this.setRequestHandlingWhenIdle(value);
    }
  }
